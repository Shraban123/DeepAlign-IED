...
class args_define():
    ...
    parser.add_argument('--remove_obsolete', default=2, type=int,
                        help="If 0, adopt the All Message Strategy: keep inseting new message blocks and never remove;\n" +
                             ...
                             "Note the message graphs for 0/1 and 2 need to be constructed differently, see the head comment of custom_message_graph.py")
    ...
    #XXXX-1
    parser.add_argument('--use_community', dest='use_community', default=False,
                        action='store_true',
                        help="If true, use community information for encoding")
    #XXXX-1
    parser.add_argument('--loss_setting', default=1, type=int,
                        help="Which loss setting to use. 1 is plain triplet loss, 2 is triplet loss + affinity, 3 is triplet loss + alignment.")
...
if __name__ == '__main__':
    ...
    for i in range(1, data_split.shape[0]):
        print("Inside inference stage") #XXXX-1

"""
This file generates the initial message features (please Methodology (Initial Feature generation) of the paper for more details).
...
print("community features: ",df.filtered_words)
...
#XXXX-1-Add community encodings
